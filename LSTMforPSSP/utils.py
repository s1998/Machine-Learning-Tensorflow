...
def raw_data_to_mini_batches():
	...
	for i in range(5534):
		...
		for j in range(len(seq)):
			temp_seq.append(word_to_glove[seq[j]])
	...
	no_of_batches = 5534 // 128
	# 5534 // 128  = 43
	# 0 - 42 batches with 128 samples
	# 43 batch with 30 samples
	# 5504 + 30 samples in total
	mini_batch_data = {}
	for i in range(no_of_batches):
		temp = []
		temp.append(seqs_in_vec[i * 128 : (i + 1) * 128 ])
		temp.append(ops[i * 128 : (i + 1) * 128 ])
		temp.append(masks[i * 128 : (i + 1) * 128 ])
		temp.append(seq_len[i * 128 : (i + 1) * 128 ])
		mini_batch_data[i] = temp

	temp = []
	temp.append(seqs_in_vec[no_of_batches * 128 : (no_of_batches + 1) * 128 ])
	temp.append(ops[no_of_batches * 128 : (no_of_batches + 1) * 128 ])
	temp.append(masks[no_of_batches * 128 : (no_of_batches + 1) * 128 ])
	temp.append(seq_len[no_of_batches * 128 : (no_of_batches + 1) * 128 ])
